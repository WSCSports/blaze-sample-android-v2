...
import com.wscsports.android.blaze.blaze_sample_android.samples.widgets.databinding.FragmentStoriesRowBinding
...
class StoriesRowFragment: BaseWidgetFragment(R.layout.fragment_stories_row) {
    ...
    override fun initWidgetView() {
        ...
        binding.storiesRowWidgetView.initWidget(
            ...
            // TODO: create a runtime change for this property
